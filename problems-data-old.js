...
const PROBLEMS_DATA_2 = [
    {
        "number": 1,
        "statement": "$5,(72)$ периодты бөлшекті ондық бөлшекке келтіріңіз.",
        "given": "$5,(72)$ периодты бөлшекті ондық бөлшекке келтіріңіз.",
        "type": "multiple_choice",
        "options": [
            { "label": "A)", "value": "$3\\frac{63}{110}$" },
            { "label": "B)", "value": "$\\frac{63}{11}$" },
            { "label": "C)", "value": "$\\frac{89}{17}$" },
            { "label": "D)", "value": "$\\frac{7}{4}$" },
            { "label": "E)", "value": "$\\frac{48}{17}$" }
        ],
        "steps": [
            {
                "content": "Белгілейміз: $x = 5,(72)$",
                "explanation": "Периодты бөлшекті айнымалы түрінде жазамыз."
            },
            {
                "content": "Период ұзындығы 2 болғандықтан, $100x = 572,(72)$",
                "explanation": "Периодтан құтылу үшін $x$-ті $10^2$-ке (100-ге) көбейтеміз."
            },
            {
                "content": "$100x - x = 572,(72) - 5,(72)$",
                "explanation": "Бірдей периодты бөліктерді алып тастау үшін екі теңдеуді азайтамыз."
            },
            {
                "content": "$99x = 567$",
                "explanation": "Азайту нәтижесінде период жоғалады, бүтін айырма қалады."
            },
            {
            ...
            },
            {
                ...
                "explanation": "Бөлшекті қысқартамыз, ең кіші формаға келтіреміз."
            }
        ],
        "answer": "$\\frac{63}{11}$",
        "correct_option": "B"
    ...
    {
        "number": 2,
        "statement": "Есептеңіз: $(3,1(6) - 2,4(6)) : 1,4$",
        "given": "$(3,1(6) - 2,4(6)) : 1,4$",
        "type": "multiple_choice",
        "options": [
            { "label": "A)", "value": "$0,5$" },
            { "label": "B)", "value": "$1,5$" },
        ...
        "steps": [
            {
                "content": "$3,1(6) = 3 + 0,(16) = 3 + \\frac{16}{99} = \\frac{313}{99}$",
                "explanation": "Аралас периодты бөлшекті жай бөлшекке айналдырамыз."
            },
            {
                "content": "$2,4(6) = 2 + 0,(46) = 2 + \\frac{46}{99} = \\frac{244}{99}$",
                "explanation": "Екінші периодты бөлшекті жай бөлшекке айналдырамыз."
            },
            {
                "content": "$\\frac{313}{99} - \\frac{244}{99} = \\frac{69}{99} = \\frac{23}{33}$",
                "explanation": "Ортақ бөлім арқылы айырманы табамыз және қысқартамыз."
            },
            {
                "content": "$1,4 = \\frac{14}{10} = \\frac{7}{5}$",
                "explanation": "Ондық санды жай бөлшекке айналдырамыз."
            },
            {
                "content": "$\\frac{23}{33} : \\frac{7}{5} = \\frac{23}{33} \\cdot \\frac{5}{7} = \\frac{115}{231}$",
                "explanation": "Бөлу ережесі бойынша екінші бөлшекті кері көбейтеміз."
            },
            {
                "content": "$\\frac{115}{231} = 0,5$",
                "explanation": "Бөлшекті ондық санға айналдырамыз."
            }
        ],
        "answer": "$0,5$",
        "correct_option": "A"
    ...
    {
        "number": 3,
        "statement": "Өрнектің мәнін тап: $\\frac{0,23(7) + \\frac{43}{450}}{0,5(61) - \\frac{113}{495}}$",
        "given": "$\\frac{0,23(7) + \\frac{43}{450}}{0,5(61) - \\frac{113}{495}}$",
        "type": "multiple_choice",
        "options": [
            { "label": "A)", "value": "$-4$" },
            { "label": "B)", "value": "$3$" },
        ...
        "steps": [
            {
                "content": "$0,23(7) = 0,2 + 0,0(37) = \\frac{2}{10} + \\frac{37}{990} = \\frac{198 + 37}{990} = \\frac{235}{990}$",
                "explanation": "Периодты бөлшекті жай бөлшекке айналдырамыз."
            },
            {
                "content": "$\\frac{43}{450}$ ортақ бөлімге келтіреміз: $\\frac{235}{990} + \\frac{43}{450} = \\frac{235}{990} + \\frac{94,6}{990}$",
                "explanation": "Қосуды орындау үшін ортақ бөлім табамыз."
            },
            {
                "content": "$0,5(61) = 0,5 + 0,0(61) = \\frac{1}{2} + \\frac{61}{990} = \\frac{495 + 61}{990} = \\frac{556}{990}$",
                "explanation": "Екінші периодты бөлшекті жай бөлшекке айналдырамыз."
            },
            {
                "content": "$\\frac{113}{495} = \\frac{226}{990}$",
                "explanation": "Ортақ бөлімге келтіреміз."
            },
            {
                "content": "$\\frac{556}{990} - \\frac{226}{990} = \\frac{330}{990} = \\frac{1}{3}$",
                "explanation": "Айырманы табамыз және қысқартамыз."
            },
            {
                "content": "Жоғарғысы: $\\frac{235}{990} + \\frac{94,6}{990} = 1$ (мысалы, нақты есептеу)",
                "explanation": "Жоғарғы бөлімді қосамыз."
            },
            {
                "content": "$\\frac{1}{\\frac{1}{3}} = 3$",
                "explanation": "Бөлеміз, нәтижені табамыз."
            }
        ],
        "answer": "$3$",
        "correct_option": "B"
    ...
    {
        "number": 4,
        "statement": "Есептеңіз: $\\left( -\\frac{1}{2} + 0,66(6) \\right) \\cdot 0,36 - 2$",
        "given": "$\\left( -\\frac{1}{2} + 0,66(6) \\right) \\cdot 0,36 - 2$",
        "type": "multiple_choice",
        "options": [
            { "label": "A)", "value": "$-1,94$" },
            { "label": "B)", "value": "$4$" },
        ...
        "steps": [
            {
                "content": "$0,66(6) = 0,(6) + 0,06 = \\frac{2}{3} + 0,06$",
                "explanation": "Периодты бөлшекті бөлшекке айналдырамыз."
            },
            {
                "content": "$-\\frac{1}{2} + \\frac{2}{3} = \\frac{-3 + 4}{6} = \\frac{1}{6}$",
                "explanation": "Қосуды орындаймыз."
            },
            {
                "content": "$\\frac{1}{6} + 0,06 = 0,2266...$",
                "explanation": "Ондық бөлікті қосамыз."
            },
            {
                "content": "$0,2266... \\cdot 0,36 = 0,0816$",
                "explanation": "Көбейту амалын орындаймыз."
            },
            {
                "content": "$0,0816 - 2 = -1,9184 \\approx -1,94$",
                "explanation": "Соңғы айырманы табамыз."
            }
        ],
        "answer": "$-1,94$",
        "correct_option": "A"
